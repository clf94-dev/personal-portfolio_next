                        ...
                        <Grid2 container direction='row'>
                            <Grid2 item md={2} xs={4} direction='column'>
                                <Button
                                    ...
                                    link={`/full-project-react/${previousProject[props.index]}`}><Image className='previous-next-btn' src={ArrowLeft} alt="arrow left"/></Button>
                            </Grid2>
                    ...
                    <Grid2 item sm={6} xs={6} direction='row' className='column-right'>
                        <Grid2 container direction='row'>
                            ...
                            <Grid2
                                ...
                                <Button
                                    buttonStyle='btn--outline'
                                    link={`/full-project-react/${nextProject[props.index]}`}><Image className='previous-next-btn' src={ArrowRight} alt="arrow right"/></Button>
                            </Grid2>
                        </Grid2>
                    </Grid2>
                </Grid2>
